...
export const getCurrentUser = async (token) => {
  return await axios.get(`${import.meta.env.VITE_API_URL}/auth`, {
    headers: {
      "x-auth-token": token,
    },
  });
...
export const updateUser = async (token, body, id) => {
  return await axios.put(
    `${import.meta.env.VITE_API_URL}/update-user?id=${id}`,
    body,
    {
      headers: {
        "x-auth-token": token,
...
export const createUser = async (token, body) => {
  return await axios.post(`${import.meta.env.VITE_API_URL}/create-user`, body, {
    headers: {
      "x-auth-token": token,
    },
  });
...
export const getUsers = async (token, body) => {
  ...
  return await axios.get(
    `${import.meta.env.VITE_API_URL}/get-users?${queryString}`,
    {
      headers: {
        "x-auth-token": token,
      },
